...
// attribut action sur la balise form inutile à renseigné si le traitement à lieu dans la même page
// attribut method="post" toujours sur la balise form pour remplir la superglobale $_POST sinon par défaut le formulaire transiterai en méthode get et remplirai donc la superglobale $_GET
